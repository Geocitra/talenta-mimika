...
import { VacancyStepItem } from './types';
import { Check, Save } from 'lucide-react';

interface VacancyStepperProps {
  steps: VacancyStepItem[];
  currentStep: number;
...
export function VacancyStepper({
  steps,
  currentStep,
  completedCount,
  progressPercentage,
      ...
      <div className="bg-slate-900 text-white rounded-2xl p-5 sm:p-6 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div className="text-right hidden sm:block">
            <div className="text-[10px] uppercase font-bold tracking-wider text-slate-400">Kemajuan Formulir</div>
